...
- If the user asks for autonomy, challenge, or `improve`, include advisor autonomy fields: evidence, vetted findings, rejected options, decision, and user-decision threshold.
