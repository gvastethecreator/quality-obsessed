...
- Advisor autonomy: when autonomy or `improve` was invoked, the work has evidence-backed findings, rejected alternatives, one recommended decision, self-contained execution steps, verification expected results, and STOP conditions.
